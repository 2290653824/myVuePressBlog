...
Synchronized是非公平锁，是否公平需要看waitset
...
> 图文详解 60 道Java并发面试高频题，这次面试，一定吊打面试官，整理：沉默王二，戳[转载链接open in new window](https://mp.weixin.qq.com/s/bImCIoYsH_JEzTkBx2lj4A)，作者：三分恶，戳[原文链接open in new window](https://mp.weixin.qq.com/s/1jhBZrAb7bnvkgN1TgAUpw)。
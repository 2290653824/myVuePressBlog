---
title: java基础知识(上)
date: 2023-06-22 16:26:47
permalink: /pages/f89778/
categories:
  - java知识点
  - java基础
  - 基础知识
...
![image-20230622172824713](https://2290653824-github-io.oss-cn-hangzhou.aliyuncs.com/image-20230622172824713.png)运行在 Java 虚拟机之上的编程语言
...
![image-20230622172951203](https://2290653824-github-io.oss-cn-hangzhou.aliyuncs.com/image-20230622172951203.png)
...
![image-20230622173004535](https://2290653824-github-io.oss-cn-hangzhou.aliyuncs.com/image-20230622173004535.png)JDK 包含 JRE
...
![image-20230622173025009](https://2290653824-github-io.oss-cn-hangzhou.aliyuncs.com/image-20230622173025009.png)

​																	Java程序转变为机器代码的过程

我们需要格外注意的是 `.class->机器码` 这一步。在这一步 JVM 类加载器首先加载字节码文件，然后通过解释器逐行解释执行，这种方式的执行速度会相对比较慢。而且，有些方法和代码块是经常需要被调用的(也就是所谓的热点代码)，所以后面引进了 JIT（just-in-time compilation） 编译器，而 JIT 属于运行时编译。当 JIT 编译器完成第一次编译后，其会将字节码对应的机器码保存下来，下次可以直接使用。而我们知道，机器码的运行效率肯定是高于 Java 解释器的。这也解释了我们为什么经常会说 **Java 是编译与解释共存的语言** 。

![image-20230622173037193](https://2290653824-github-io.oss-cn-hangzhou.aliyuncs.com/image-20230622173037193.png)
...
![image-20230622173048654](https://2290653824-github-io.oss-cn-hangzhou.aliyuncs.com/image-20230622173048654.png)

JDK、JRE、JVM、JIT 这四者的关系

下面这张图是 JVM 的大致结构模型。

![image-20230622173104683](https://2290653824-github-io.oss-cn-hangzhou.aliyuncs.com/image-20230622173104683.png)
...
![image-20230622173117803](https://2290653824-github-io.oss-cn-hangzhou.aliyuncs.com/image-20230622173117803.png)
...
![image-20230622173127215](https://2290653824-github-io.oss-cn-hangzhou.aliyuncs.com/image-20230622173127215.png)oracle jdk release cadence
...
![img](https://oscimg.oschina.net/oscnet/up-5babce06ef8fad5c4df5d7a6cf53d4a7901.png)
...
![image-20230622173133701](https://2290653824-github-io.oss-cn-hangzhou.aliyuncs.com/image-20230622173133701.png)Java 注释类型总结
...
![image-20230622173140781](https://2290653824-github-io.oss-cn-hangzhou.aliyuncs.com/image-20230622173140781.png)
...
![image-20230622173151800](https://2290653824-github-io.oss-cn-hangzhou.aliyuncs.com/image-20230622173151800.png)Java 移位运算符总结
...
![image-20230622173203368](https://2290653824-github-io.oss-cn-hangzhou.aliyuncs.com/image-20230622173203368.png)基本类型 vs 包装类型
...
![img](https://oscimg.oschina.net/oscnet/up-1ae0425ce8646adfb768b5374951eeb820d.png)
...
![image-20230622173212689](https://2290653824-github-io.oss-cn-hangzhou.aliyuncs.com/image-20230622173212689.png)成员变量 vs 局部变量

---
title: SPI机制
date: 2023-06-23 12:35:49
permalink: /pages/d2e56c/
categories:
  - java知识点
  - java基础
  - 基础知识
...
java 6 引入 ，是一种基于ClassLoader来发现并加载服务的机制

一个标准的SPI包含3个：

- Service 接口定义
- Service Provider 接口实现
- ServiceLoader 调用方根据约定加载实现
...
SPI 将服务接口和具体的服务实现分离开来，将**服务调用方**和**服务实现者**解耦，能够提升程序的扩展性、可维护性。修改或者替换服务实现并不需要修改调用方。

很多框架都使用了 Java 的 SPI 机制，比如：Spring 框架、数据库加载驱动、日志接口、以及 Dubbo 的扩展实现等等。

![image-20230623152347307](https://2290653824-github-io.oss-cn-hangzhou.aliyuncs.com/image-20230623152347307.png)
...
![image-20230623162813287](https://2290653824-github-io.oss-cn-hangzhou.aliyuncs.com/image-20230623162813287.png)
...
![image-20230623162819564](https://2290653824-github-io.oss-cn-hangzhou.aliyuncs.com/image-20230623162819564.png)

这就是依赖 SPI 机制实现的，那我们接下来就实现一个简易版本的日志框架。

slf4j是官方是怎么实现上slf4j的呢？可以参考[从SLF4J源码角度分析SPI机制](https://juejin.cn/post/7241187132890742845)
...
![image-20230623162829833](https://2290653824-github-io.oss-cn-hangzhou.aliyuncs.com/image-20230623162829833.png)

再点击 OK 。

![image-20230623162836866](https://2290653824-github-io.oss-cn-hangzhou.aliyuncs.com/image-20230623162836866.png)
...
![image-20230623162841723](https://2290653824-github-io.oss-cn-hangzhou.aliyuncs.com/image-20230623162841723.png)
...
[b站](https://www.bilibili.com/video/BV1RY4y1v7mN/?spm_id_from=333.337.top_right_bar_window_history.content.click&vd_source=a05a4698720267eb93bab07197b4276c)

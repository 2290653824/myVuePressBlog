---
title: JVM
date: 2023-08-17 13:15:03
permalink: /pages/669807/
categories:
  - 工作
  - 八股记忆
tags:
...
![image-20230817132814675](https://2290653824-github-io.oss-cn-hangzhou.aliyuncs.com/image-20230817132814675.png)

同时 JVM 也是一个跨语言的平台，和语言无关，只和 class 的文件格式关联，任何语言，只要能翻译成符合规范的字节码文件，都能被 JVM 运行。

![image-20230817132929338](https://2290653824-github-io.oss-cn-hangzhou.aliyuncs.com/image-20230817132929338.png)
...
![image-20230817133015298](https://2290653824-github-io.oss-cn-hangzhou.aliyuncs.com/image-20230817133015298.png)
...
![image-20230817133221761](https://2290653824-github-io.oss-cn-hangzhou.aliyuncs.com/image-20230817133221761.png)Java虚拟机栈
...
![image-20230817133417559](https://2290653824-github-io.oss-cn-hangzhou.aliyuncs.com/image-20230817133417559.png)Java 堆内存结构

**5）方法区**

方法区是比较特别的一块区域，和堆类似，它也是各个线程共享的内存区域，用于存储已被虚拟机加载的类型信息、常量、静态变量、即时编译器编译后的代码缓存等数据。关于运行时的更多知识点:[https://2290653824.github.io/pages/bcb6e8/](https://2290653824.github.io/pages/bcb6e8/)
...
- [面渣逆袭 Java SE 篇👍open in new window](https://tobebetterjavaer.com/sidebar/sanfene/javase.html)
- [面渣逆袭 Java 集合框架篇👍open in new window](https://tobebetterjavaer.com/sidebar/sanfene/javathread.html)
- [面渣逆袭 Java 并发编程篇👍open in new window](https://tobebetterjavaer.com/sidebar/sanfene/collection.html)
- [面渣逆袭 JVM 篇👍open in new window](https://tobebetterjavaer.com/sidebar/sanfene/jvm.html)
- [面渣逆袭 Spring 篇👍open in new window](https://tobebetterjavaer.com/sidebar/sanfene/spring.html)
- [面渣逆袭 Redis 篇👍open in new window](https://tobebetterjavaer.com/sidebar/sanfene/redis.html)
- [面渣逆袭 MyBatis 篇👍open in new window](https://tobebetterjavaer.com/sidebar/sanfene/mybatis.html)
- [面渣逆袭 MySQL 篇👍open in new window](https://tobebetterjavaer.com/sidebar/sanfene/mysql.html)
- [面渣逆袭操作系统篇👍open in new window](https://tobebetterjavaer.com/sidebar/sanfene/os.html)
- [面渣逆袭计算机网络篇👍open in new window](https://tobebetterjavaer.com/sidebar/sanfene/network.html)
- [面渣逆袭RocketMQ篇👍open in new window](https://tobebetterjavaer.com/sidebar/sanfene/rocketmq.html)
...
> 图文详解 50 道Java虚拟机高频面试题，这次面试，一定吊打面试官，整理：沉默王二，戳[转载链接open in new window](https://mp.weixin.qq.com/s/bHhqhl8mH3OAPt3EkaVc8Q)，作者：三分恶，戳[原文链接open in new window](https://mp.weixin.qq.com/s/XYsEJyIo46jXhHE1sOR_0Q)。
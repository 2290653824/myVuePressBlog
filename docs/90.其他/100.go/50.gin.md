...
# [全局注册中间件](https://docs.fengfengzhidao.com/#/docs/Gin框架文档/6.中间件和路由?id=全局注册中间件)
...
## [路由分组注册中间件](https://docs.fengfengzhidao.com/#/docs/Gin框架文档/6.中间件和路由?id=路由分组注册中间件)
...
# [gin.Default](https://docs.fengfengzhidao.com/#/docs/Gin框架文档/6.中间件和路由?id=gindefault)

...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
    ...
    locales: {
        '/': {
            lang: 'zh-CN',
            title: "baby sword‘s blog",
            description: 'java后端技术总结，生活记录。个人笔记',
        }
    },
    ...
    themeConfig: {
        ...
        nav: [
                ...
                text: '数据库', link: '/database/', items: [

                    {
                        text: 'mysql', link: '/mysql/', items: [
                            {
                                text: 'mysql索引',
                                link: '/mysqlIndex/',
                                items: [{text: '什么是索引下推', link: '/pages/5c7414/'}, {
                                    text: '索引失效情况',
                                    link: '/pages/d05ed2/'
                                }, {text: 'mysql优化成本计算', link: '/pages/411af3/'}]
                            },
                            {
                                text: 'mysql日志',
                                link: '/mysqllog/',
                                items: [{text: 'mysql日志详情', link: '/pages/6bc60e/'}, {
                                    text: 'binlog数据恢复详解',
                                    link: '/pages/4267a9/'
                                }, {text: 'bufferPool详解', link: '/pages/8983b5/'}, {
                                    text: '你常听说的WAL到底是什么',
                                    link: '/pages/8ca146/'
                                }]
                            }
                        ...
                        text: 'redis', link: '/redis/', items: [{text: '单机下的redis', link: '/singleredis/'}, {
                            ...
                            }, {text: 'redisson详解', link: '/pages/83fd96/'}, {
                                text: 'raft协议浅析',
                                link: '/pages/ee4ba0/'
                            }
                            ]
...

            {
                ...
                items: [
                    ...
                    {text: 'Spring', link: '/structure/Spring/'}, {
                        text: 'springboot',
                        link: '/structure/springboot/'
                    }, {text: 'RPC', link: '/structure/RPC/'}, {
                        text: 'netty',
                        link: '/structure/netty/'
                    }, {text: 'mybatis', link: '/structure/mybatis/'}, {text: 'maven', link: '/structure/maven/'}
                ]
            ...
            },
            {
                text: '中间件',
                link: '/middleware/',
                items: [{text: '消息队列', link: '/middleware/messageQueue/'}, {
                    text: 'kafka',
        ...
        repo: '2290653824/myVuePressBlog', // 导航栏右侧生成Github链接
        ...
        author: {
            name: 'zhengjian', // 必需
            link: 'https://github.com/2290653824', // 可选的
        },

        // 博主信息 (显示在首页侧边栏)
        blogger: {
            avatar: 'img/myAvator.png',
            name: 'zhengjian',
            slogan: '不敢承担失去的风险，是不可能抓住梦想的',
        },
            ...
            icons: [
                {
                    ...
                    title: '发邮件',
                    link: '2290653824@qq.com',
                },
                {
                    iconClass: 'icon-github',
                    title: 'GitHub',
                    link: 'https://github.com/2290653824',
                },
                {
                    iconClass: 'icon-erji',
                    title: '听音乐',
                    link: 'https://music.163.com/#/playlist?id=430175831',
                },
            ],
        },
    ...
    plugins: <UserPlugins>[
        ...
        [
            'vuepress-plugin-comment', // 评论
            {
                choosen: 'gitalk',
                options: {
                    clientID: 'fd0876aff2f578bbd067',
                    clientSecret: '0f2fb7d0e4dd7a64d620af2300510d250f711a32',
                    repo: 'myVueBlog-gitalk-comment', // GitHub 仓库
                    owner: '2290653824', // GitHub仓库所有者
                    admin: ['2290653824'], // 对仓库有写权限的人
